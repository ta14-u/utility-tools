...
describe("qr/decode/zxing", () => {
  describe("decodeWithZXing", () => {
    it("should decode successfully with HybridBinarizer on first attempt", () => {
      ...
      vi.mocked(MultiFormatReader).mockImplementation(function (this: {
        decode: typeof mockDecode;
        setHints: typeof mockSetHints;
      }) {
    ...
    it("should try inverted luminance source when normal source fails", () => {
      ...
      vi.mocked(InvertedLuminanceSource).mockImplementation(function (
        this: InvertedLuminanceSource,
      ) {
