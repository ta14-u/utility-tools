 ...
 * @property encoding - 検出されたエンコーディング（Alphanumeric mode, Numeric mode, UTF-8, UTF-8 (Byte mode), Shift-JIS, Shift-JIS (Byte mode), Shift-JIS (Kanji mode), Binary, Unknown）
 */
